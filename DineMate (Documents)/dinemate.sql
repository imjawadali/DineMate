...
--
-- Host: dinematedev.csrzbhrmzsxf.us-east-2.rds.amazonaws.com    Database: sys
-- ------------------------------------------------------
...
-- Dump completed on 2021-10-14 18:39:15
-- MySQL dump 10.13  Distrib 8.0.20, for macos10.15 (x86_64)
--
-- Host: dinematedev.csrzbhrmzsxf.us-east-2.rds.amazonaws.com    Database: DineMateDev
-- ------------------------------------------------------
-- Server version	8.0.23
...
--
-- Table structure for table `addOnOptions`
--

DROP TABLE IF EXISTS `addOnOptions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `addOns` (
  ...
  CONSTRAINT `menuItemId` FOREIGN KEY (`menuId`) REFERENCES `menu` (`id`)
...
CREATE TABLE `categories` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`,`restaurantId`),
  UNIQUE KEY `name_2` (`name`,`restaurantId`),
...
CREATE TABLE `customers` (
  ...
  `hashString` varchar(45) DEFAULT NULL,
  `passwordForgotten` tinyint NOT NULL DEFAULT '0',
...
CREATE TABLE `genericData` (
  ...
  `isFaq` tinyint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE `menu` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `restaurantId` (`restaurantId`,`name`),
  KEY `restaurantId_idx` (`restaurantId`)
...
CREATE TABLE `orderItemAddOns` (
  ...
  `addOnOptionId` int DEFAULT NULL,
  `addOnOption` varchar(45) DEFAULT NULL,
  `price` double NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE `orderItems` (
  `id` int NOT NULL AUTO_INCREMENT,
  `restaurantId` varchar(45) NOT NULL,
  `orderNumber` int(3) unsigned zerofill NOT NULL,
  ...
  `splitted` tinyint NOT NULL DEFAULT '0',
  `vanished` tinyint NOT NULL DEFAULT '0',
  `specialInstructions` varchar(200) DEFAULT NULL,
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1796 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders` (
  ...
  `orderNumber` int(3) unsigned zerofill NOT NULL,
  `type` varchar(15) NOT NULL DEFAULT 'Dine-In',
  `ready` tinyint NOT NULL DEFAULT '0',
  `status` tinyint NOT NULL DEFAULT '1',
  `customerStatus` tinyint NOT NULL DEFAULT '0',
  `doNotDisturb` tinyint NOT NULL DEFAULT '0',
  `pointsToRedeem` int NOT NULL DEFAULT '0',
...
CREATE TABLE `restaurants` (
  ...
  `cuisine` varchar(45) NOT NULL DEFAULT 'Others',
  ...
  `ratingCounts` int NOT NULL DEFAULT '0',
  `taxId` varchar(45) NOT NULL,
  `taxPercentage` float NOT NULL,
  `customMessage` varchar(255) DEFAULT NULL,
  `lateTime` int NOT NULL DEFAULT '10',
  `stripeConnectedAccountId` varchar(45) DEFAULT NULL,
  `primaryContactId` int NOT NULL,
  `secondaryContactId` int DEFAULT NULL,
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Table structure for table `restaurantsQrs`
--

DROP TABLE IF EXISTS `restaurantsQrs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `restaurantsQrs` (
  `id` int NOT NULL AUTO_INCREMENT,
  `restaurantId` varchar(45) NOT NULL,
  `tableName` varchar(45) DEFAULT NULL,
  `value` varchar(5) NOT NULL,
  `mergeId` varchar(100) DEFAULT NULL,
  `active` tinyint NOT NULL DEFAULT '1',
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `scheduleManagement`
--

DROP TABLE IF EXISTS `scheduleManagement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `servicesQue`
--

DROP TABLE IF EXISTS `servicesQue`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `servicesQue` (
  `id` int NOT NULL AUTO_INCREMENT,
  `restaurantId` varchar(45) NOT NULL,
  `tableNumber` varchar(100) NOT NULL,
  `orderNumber` int(3) unsigned zerofill NOT NULL,
  `type` int NOT NULL DEFAULT '0',
  `text` varchar(200) NOT NULL DEFAULT 'Water',
  `status` tinyint NOT NULL DEFAULT '1',
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `staffAssignedTables`
--

DROP TABLE IF EXISTS `staffAssignedTables`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `staffAssignedTables` (
  `staffId` int NOT NULL,
  `tableNumber` varchar(5) NOT NULL,
  `restaurantId` varchar(45) NOT NULL,
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`staffId`,`tableNumber`,`restaurantId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `hashString` varchar(45) DEFAULT NULL,
  `passwordForgotten` tinyint NOT NULL DEFAULT '1',
  `active` tinyint NOT NULL DEFAULT '1',
  ...
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `passwordLastUpdated` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `email_UNIQUE` (`email`)
...
-- Dump completed on 2021-10-14 18:40:08

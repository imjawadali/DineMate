...
function MenuItemsByKitchen() {
  ...
  const getFilteredList = () => {
    ...
    if (filterKey && filterKey.length && menuItemsReports) {
      filteredRestaurants = menuItemsReports.filter(
        ...
        || (item.kitchen || "").toLowerCase().includes(filterKey.toLowerCase())
      )
    }
  ...
  return (
    <div className="Container">
      <h2>Report by Kitchen Staff by Menu Item</h2>
...
export default MenuItemsByKitchen
